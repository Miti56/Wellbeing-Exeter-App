...
<form action="categoryCreateDb.php" method="post">
    Category name:
    <input type="text" placeholder="Enter Category" name="cname" id="cname" required="true" value="category">
    <p>
        3 character code: <input type="text" placeholder="Enter Category" name="charcode" id="charcode" value="code">
    <p>
